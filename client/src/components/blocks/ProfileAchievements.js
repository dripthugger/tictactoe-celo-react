import { loadUserWinsHashes, loadMintednft, saveMintedNftData } from "../../utils/serverapi";
...
*/
const ProfileAchievements = ({ TictactoeContract }) => {
    ...
    const loadAchievements = useCallback(async (address) => {
        // Save a length of array with blockchain hashes of user's wins from the server
        setWinsCount( (await loadUserWinsHashes(address)).length )
